public class DoubleLinekedList<T> {
    ...
    public boolean insertToFront(T existedData , T addData) {
        ...
        if (this.head == null) {
            ...
            this.tail = this.head;
        } else if (this.head.data == existedData) { // Head 앞에 데이터를 넣는 조건일 경우
            Node<T> newHead = new Node<T>(addData);
            newHead.next = this.head;
            return true;
        } else { // 중간에 데이터를 넣는 조건일 경우
    ...
    public static void main(String[] args) {
        ...
        System.out.println(doubleLinkedList.searchFromHead(70));
    }
}
